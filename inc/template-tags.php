...
if ( ! function_exists( 'angular_material_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function angular_material_posted_on() {
...
if ( ! function_exists( 'angular_material_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function angular_material_entry_footer() {
	// Hide category and tag text for pages.
	if ( 'post' === get_post_type() ) {
		/* translators: used between list items, there is a space after the comma */
		$categories_list = get_the_category_list( esc_html__( ', ', 'angular-material' ) );
		if ( $categories_list && angular_material_categorized_blog() ) {
 ...
 * @return bool
 */
function angular_material_categorized_blog() {
	...
	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so angular_material_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so angular_material_categorized_blog should return false.
		return false;
	}
}
 ...
 */
function angular_material_category_transient_flusher() {
...
add_action( 'edit_category', 'angular_material_category_transient_flusher' );
add_action( 'save_post',     'angular_material_category_transient_flusher' );
